...
const Login = () => {
  ...
  return (
    <div className='pt-32 text-[#CBD5E1] flex items-center justify-center text-center'>
        <form onSubmit={handleOnSubmit}>
            <div>
                <label>Email: </label>
                <input className='bg-transparent outline' onChange={(e) => setEmail(e.target.value)} />
            </div>
            <div>
                <label>Password: </label>
                <input className='bg-transparent outline' onChange={(e) => setPassword(e.target.value)} />
            </div>
